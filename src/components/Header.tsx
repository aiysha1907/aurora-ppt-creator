      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <div className="group relative">
            ...
            <div className="absolute right-0 mt-2 w-36 py-2 rounded-lg bg-presly-background border border-presly-accent/10 backdrop-blur-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
              <a
                href="#"
